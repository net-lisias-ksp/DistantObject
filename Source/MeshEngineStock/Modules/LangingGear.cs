...
{
	public class LandingGear : DistantObject.MeshEngine.Contract.Module.Interface
	{
		private const string MODULE_NAME = "ModuleWheelDeployment";
		...
		GameObject Contract.Module.Interface.Render(GameObject mesh, ProtoPartSnapshot part, AvailablePart avPart)
		{
			...
			//if (landingGear.moduleValues.GetValue("savedAnimationTime") != "0")
			{
				...
				Animation[] animator = avPart.partPrefab.FindModelAnimators();
